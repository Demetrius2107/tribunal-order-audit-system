...
import com.demetrius.tribunal.billing.application.dto.ReconcileRecordResult;
...
/**
 * 对账差异记录查询应用服务（F-607：对账结果产品化）。
 *
 * <p>财务对账任务写入的差异记录（t_reconcile_record）分页查询，供运营查看差异明细。</p>
 */
@Service
